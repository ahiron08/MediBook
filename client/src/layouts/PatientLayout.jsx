        ...
        >
          ...
          {!collapsed && (
            <>
              ...
              <span className="ml-auto px-2 py-0.5 text-[10px] font-medium text-[var(--color-success)] bg-[var(--color-success-50)] rounded-full">Patient</span>
            </>
          )}
        </div>
        ...
        {!collapsed && (
          <div className="px-4 pt-4 pb-3">
            <div className="bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-dark)] rounded-[var(--radius-lg)] p-4">
              <p className="text-[11px] text-white/70 mb-0.5">Welcome,</p>
